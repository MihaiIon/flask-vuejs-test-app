...
def test_author_creation__error_when_attempting_to_create_a_author_with_an_empty_first_name(client):
...
def test_author_creation__error_when_attempting_to_create_a_author_with_an_empty_last_name(client):
